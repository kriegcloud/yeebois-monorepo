...
yeebois-monorepo comes with built-in dark mode support through the combination of [Tailwind CSS](https://tailwindcss.com/docs/dark-mode) and [next-themes](https://github.com/pacocoursey/next-themes).
...
```tsx page.tsx
import { ModeToggle } from '@dank/design-system/components/mode-toggle';
