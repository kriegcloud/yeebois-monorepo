...
{/* yeebois-monorepo relies on Next.js's built-in [Metadata](https://nextjs.org/docs/app/building-your-application/optimizing/metadata) API to handle most of our SEO needs. Specifically, the `@dank/seo` package provides a `createMetadata` function that you can use to generate metadata for your pages. For example: */}

{/* ```tsx page.tsx */}
{/* import { createMetadata } from '@dank/seo/metadata'; */}
