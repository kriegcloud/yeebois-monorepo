---
title: Overview
description: Overview of yeebois-monorepo
---

## What is yeebois-monorepo?

yeebois-monorepo is a production-grade [Turborepo](https://turbo.build/repo) template for [Next.js](https://nextjs.org/) apps. It is designed to be a comprehensive starting point for new apps, providing a solid, opinionated foundation with a minimal amount of configuration.
...
yeebois-monorepo is focused on these key principles.
