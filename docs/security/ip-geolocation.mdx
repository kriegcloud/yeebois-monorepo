...
yeebois-monorepo uses [Arcjet](https://arcjet.com) for [application security](/security/application) which includes [IP details and geolocation information](https://docs.arcjet.com/reference/nextjs#ip-analysis) you can use in your application.
