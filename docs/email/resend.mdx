...
We use [Resend](https://resend.com/) to send transactional emails. The templates, located in `@dank/email`, are powered by [React Email](https://react.email/) - a collection of high-quality, unstyled components for creating beautiful emails using React and TypeScript.
...
import { resend } from '@dank/email';
import { ContactTemplate } from '@dank/email/templates/contact';
