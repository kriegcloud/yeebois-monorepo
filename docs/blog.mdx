...
yeebois-monorepo uses [Content Collections](https://www.content-collections.dev/) to generate type-safe data collections from MDX files. This approach provides a structured way to manage blog posts while maintaining full type safety throughout your application.
...
Collections in yeebois-monorepo are enhanced with several utilities to improve the reading experience and performance:
