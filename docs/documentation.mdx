---
title: Documentation
description: How the documentation is configured in yeebois-monorepo.
---
...
yeebois-monorepo uses [Mintlify](https://mintlify.com) to generate beautiful docs. Each page is a `.mdx` file, written in Markdown, with built-in UI components and API playground.
