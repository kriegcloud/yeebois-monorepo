...
description: How to handle environment variables in yeebois-monorepo
---

yeebois-monorepo uses [@t3-oss/env-nextjs](https://github.com/t3-oss/t3-env) to handle environment variables in a type-safe way. This provides runtime validation and autocompletion for all environment variables.
