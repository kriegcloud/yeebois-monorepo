---
title: Testing
description: How we've configured testing in yeebois-monorepo.
---

yeebois-monorepo uses [Vitest](https://vitest.dev/) for unit testing. It's a fast and lightweight testing framework that's compatible with Jest's API. Unit tests are run automatically as part of the `build` task in Turborepo.
